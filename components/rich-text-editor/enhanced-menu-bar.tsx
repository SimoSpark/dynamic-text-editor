  ...
  export default function EnhancedMenuBar({ editor, patient }: MenuBarProps) {
    ...
    return (
      <div className="border rounded-md p-1 mb-1 bg-slate-50 flex items-center flex-wrap gap-1">
        ...
        {/* Dropdown pour la signature du médecin */}
        <DropdownMenu>
          <DropdownMenuTrigger asChild>
            <Button
              variant="ghost"
        ...
        {/* Dropdown pour sections de rapport */}
        <DropdownMenu>
          <DropdownMenuTrigger asChild>
            <Button
              variant="ghost"
          ...
          <DropdownMenuContent align="end" className="w-48">
            <DropdownMenuItem onClick={() => insertReportSection("examination")}>
              Examen clinique
            </DropdownMenuItem>
            <DropdownMenuItem onClick={() => insertReportSection("diagnosis")}>
              Diagnostic
            </DropdownMenuItem>
            <DropdownMenuItem onClick={() => insertReportSection("treatment")}>
              Traitement
            </DropdownMenuItem>
            <DropdownMenuItem onClick={() => insertReportSection("followup")}>
              Suivi
            </DropdownMenuItem>
          </DropdownMenuContent>
        </DropdownMenu>
  
        {/* Dropdown pour info patient */}
        {patient && (
          <DropdownMenu>
            <DropdownMenuTrigger asChild>
              <Button
